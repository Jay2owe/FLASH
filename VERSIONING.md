...
- `5.0.0` is the first public release baseline, adding portable project handling, expanded deconvolution and parameter-variation workflows, object intensity profiling, and broad runtime and ownership hardening.
