...
public final class SpatialHelpCatalog {
    ...
    public static final SetupHelpTopic COLOCALIZATION = topic(
            ...
            section("Requires",
                    ...
                    "CPC needs object label images under FLASH/Results/Analysis Images/Segmentation/.",
    ...
    public static final SetupHelpTopic BB_COLOCALIZATION = topic(
            ...
            section("When to use",
                    "As a fast, permissive proximity screen - box overlap is cheap and tolerant of small segmentation gaps that defeat voxel-level overlap.",
                    "BB-CPC when 'centroid sits within a partner's extent' is the question (engulfment or containment) but you want the box as a forgiving stand-in for the partner volume.",
                    "Volume fill to ask how densely partner signal packs an object's box - a single dominant partner (best) versus crowding from many (total)."),
            section("Requires",
