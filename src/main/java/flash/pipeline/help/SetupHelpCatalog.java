...
public final class SetupHelpCatalog {
    ...
    public static final SetupHelpTopic CHANNEL_IDENTITY = topic(
            ...
            section("Saved output",
                    "FLASH saves these choices in FLASH/Config/.settings/channel_config.json."));
    ...
    public static final SetupHelpTopic Z_SLICE_SUBSET = topic(
            ...
            section("Saved output",
                    "FLASH saves selected ranges in FLASH/Config/.settings/channel_config.json."),
            section("Watch out",
    ...
    public static final SetupHelpTopic DISPLAY_RANGE = topic(
            ...
            section("Brightness/Contrast",
                    "Manual min/max display range: set the dark and bright ends directly.",
                    "Auto-enhance contrast: compute the display range from each image using the saturated-pixels percentage.",
                    "Minimum: signal value shown as the dark end of the manual display range.",
                    "Maximum: signal value shown as the bright end of the manual display range.",
                    "Brightness: moves the display range up or down.",
                    "Contrast: widens or narrows the display range.",
                    "Suggest: suggests a manual display range from the image histogram.",
