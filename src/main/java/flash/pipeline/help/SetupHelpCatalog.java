...
public final class SetupHelpCatalog {
    ...
    public static final SetupHelpTopic CLASSICAL_OBJECT_SEGMENTATION = topic(
            ...
            section("Particle Size",
                    ...
                    "Threshold used: shows the threshold used to create the object preview.",
                    "Run Preview: runs 3D object detection with the current size range.",
                    "Reset to saved: restores the saved size range.",
                    "Filtered: preview the filtered image used for object detection.",
                    "Raw: preview the original channel before filtering.",
                    "Overlay objects: draw detected objects over the selected preview source."),
            section("Watch out",
