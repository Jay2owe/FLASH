...
public final class FlashProjectLayout {
    ...
    public static final String OBJECT_INTENSITY_PROFILING_DIR = "Object Intensity Profiling";
    ...
    /** CSV output for Object Intensity Profiling (per-object long form + aggregated mean±SEM). */
    public File tablesObjectIntensityProfilingWriteDir() {
        return new File(tablesRoot(), OBJECT_INTENSITY_PROFILING_DIR);
    }

    /** Aggregate figures for Object Intensity Profiling (marginal montage + radial overlay). */
    public File analysisImagesObjectIntensityProfilingDir() {
        return new File(analysisImagesRoot(), OBJECT_INTENSITY_PROFILING_DIR);
    }
