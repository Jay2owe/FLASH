...
public final class NextStepLabels {
    ...
    public static final String DECONV_PREVIEW_IMAGES = "Next: Choose preview images";
    public static final String DECONV_CHANNEL_SETTINGS = "Next: Channel settings";
    public static final String PREVIEW_DECONVOLUTION = "Next: Preview deconvolution";
    public static final String NEXT_RUN_DECONVOLUTION = "Next: Run deconvolution";
    ...
    public static String deconvolutionAcquisitionPrimaryLabel(boolean choosePreviewImages) {
        return choosePreviewImages ? DECONV_PREVIEW_IMAGES : DECONV_CHANNEL_SETTINGS;
    }

    public static String deconvolutionChannelPrimaryLabel(String nextChannelName) {
        String name = nextChannelName == null ? "" : nextChannelName.trim();
        return name.isEmpty() ? NEXT_RUN_DECONVOLUTION : "Next: " + name + " settings";
    }
