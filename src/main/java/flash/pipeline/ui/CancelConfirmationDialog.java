...
public final class CancelConfirmationDialog {
    ...
    public static Choice show(Window owner, String stepLabel,
        ...
        JLabel explanation = new JLabel(
                "<html><body width='420'>Save &amp; Exit validates and checkpoints the values "
                        + "currently visible on this page. Discard Draft &amp; Exit removes this "
                        + "unfinished generation.</body></html>");
        explanation.setFont(FlashTheme.body());
        explanation.setForeground(FlashTheme.TEXT_PRIMARY);
        ...
        if (draftPath != null && !draftPath.trim().isEmpty()) {
            JLabel savedTo = new JLabel("<html><body width='420'>Draft file: "
        ...
        JButton discard = new JButton("Discard Draft & Exit");
