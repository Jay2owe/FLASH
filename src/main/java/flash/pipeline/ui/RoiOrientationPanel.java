...
public final class RoiOrientationPanel {
    ...
    private JPanel buildApplyToRow() {
        ...
        row.setAlignmentX(JPanel.LEFT_ALIGNMENT);
        wrap.add(row);
        JLabel scopeHint = new JLabel("Choose how many images this orientation is applied to.");
        scopeHint.setFont(scopeHint.getFont().deriveFont(java.awt.Font.PLAIN, 11f));
        scopeHint.setForeground(new java.awt.Color(117, 117, 117));
        scopeHint.setAlignmentX(JPanel.LEFT_ALIGNMENT);
        wrap.add(scopeHint);
        return wrap;
    }
