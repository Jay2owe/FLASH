...
public final class JsonIO {
    ...
    /** Lenient double reader with a fallback for absent/malformed values. */
    ...
    /**
     * Nullable double reader: {@code null} when the value is absent or not a parseable number.
     * Used for lenient raw config primitives that must never make a decode throw (a bad number
     * degrades to "unset" rather than corrupting the whole config).
     */
    ...
    /** Nullable integer reader: {@code null} when the value is absent or not a parseable integer. */
