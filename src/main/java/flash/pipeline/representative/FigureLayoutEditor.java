...
public final class FigureLayoutEditor extends JDialog {
    ...
    private JPanel buildSidePanel() {
        ...
        side.add(imagesRow);
        JLabel imagesHint = new JLabel("Off shows condition colours; on loads the actual tiles (slower).");
        imagesHint.setFont(imagesHint.getFont().deriveFont(java.awt.Font.PLAIN, 11f));
        imagesHint.setForeground(new java.awt.Color(117, 117, 117));
        imagesHint.setAlignmentX(Component.LEFT_ALIGNMENT);
        side.add(imagesHint);
        ...
        side.add(headersRow);
        JLabel headersHint = new JLabel("Draw row and column labels on the exported figure.");
        headersHint.setFont(headersHint.getFont().deriveFont(java.awt.Font.PLAIN, 11f));
        headersHint.setForeground(new java.awt.Color(117, 117, 117));
        headersHint.setAlignmentX(Component.LEFT_ALIGNMENT);
        side.add(headersHint);
