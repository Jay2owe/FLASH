...
public class NextStepLabelsTest {
    ...
    @Test
    public void deconvolutionStagedSetupNamesNextDestination() {
        assertEquals(NextStepLabels.DECONV_PREVIEW_IMAGES,
                NextStepLabels.deconvolutionAcquisitionPrimaryLabel(true));
        assertEquals(NextStepLabels.DECONV_CHANNEL_SETTINGS,
                NextStepLabels.deconvolutionAcquisitionPrimaryLabel(false));
        assertEquals("Next: DAPI settings",
                NextStepLabels.deconvolutionChannelPrimaryLabel(" DAPI "));
        assertEquals(NextStepLabels.NEXT_RUN_DECONVOLUTION,
                NextStepLabels.deconvolutionChannelPrimaryLabel(" "));
    }
    ...
    public void destinationConstantsUseNextPrefix() {
        ...
        assertEquals("Next: Choose preview images", NextStepLabels.DECONV_PREVIEW_IMAGES);
        assertEquals("Next: Channel settings", NextStepLabels.DECONV_CHANNEL_SETTINGS);
        assertEquals("Next: Preview deconvolution", NextStepLabels.PREVIEW_DECONVOLUTION);
        assertEquals("Next: Run deconvolution", NextStepLabels.NEXT_RUN_DECONVOLUTION);
