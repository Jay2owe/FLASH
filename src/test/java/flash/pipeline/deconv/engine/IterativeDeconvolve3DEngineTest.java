...
public class IterativeDeconvolve3DEngineTest {

    @Test
    public void deconvolveSharpensABlurredPointAndPreservesDimensions() throws Exception {
        IterativeDeconvolve3DEngine engine = new IterativeDeconvolve3DEngine();
        Assume.assumeTrue("Iterative Deconvolve 3D is not available in this runtime.", engine.isAvailable());
        Assume.assumeFalse("Iterative Deconvolve 3D macro execution requires a non-headless runtime.",
