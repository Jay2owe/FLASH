...
public class MetricStatisticsEngineRoutingTest {
    ...
    @Test
    public void withinAnimalPaired_twoGroups_invokesPairedTTest() {
        StatisticsConfig cfg = new StatisticsConfig();
        cfg.pairedMode = StatisticsConfig.PairedMode.WITHIN_ANIMAL;
    ...
    @Test
    public void withinAnimalPaired_twoGroups_skewedRoutesToWilcoxon() {
        StatisticsConfig cfg = new StatisticsConfig();
        cfg.pairedMode = StatisticsConfig.PairedMode.WITHIN_ANIMAL;
        cfg.distributionMode = StatisticsConfig.DistributionMode.ASSUME_SKEWED;
