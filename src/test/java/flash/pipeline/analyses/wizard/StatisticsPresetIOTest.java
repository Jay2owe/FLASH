...
public class StatisticsPresetIOTest {
    ...
    public void stockPresetsBootstrapWhenDirectoryIsEmpty() throws Exception {
        ...
        assertTrue(new File(presetDir, "2_group_paired_within_animal.json").isFile());
    ...
    @Test
    public void pairedWithinAnimalPresetRequestsWithinAnimalPairing() throws Exception {
        StatisticsPreset preset = loadStock("2_group_paired_within_animal");

        assertEquals(StatisticsConfig.PairedMode.WITHIN_ANIMAL, preset.getPairedMode());
        assertEquals(StatisticsConfig.DistributionMode.AUTO, preset.getDistributionMode());
        assertEquals(StatisticsConfig.PostHocMethod.BONFERRONI, preset.getPostHocMethod());
    }
    ...
    public void saveLoadDeleteRoundTrip() throws Exception {
        ...
        StatisticsPreset preset = new StatisticsPreset(
                "My Custom",
                "For testing",
                StatisticsConfig.PairedMode.WITHIN_ANIMAL,
        ...
        assertEquals(StatisticsConfig.PairedMode.WITHIN_ANIMAL, loaded.getPairedMode());
