...
public class ReplayCommandFormatterTest {
    ...
    public void formatsSingleChannelIntensityReplayWithParseableCliOptions() {
        ...
        assertTrue(command.startsWith("IJ.run(\"FLASH\""));
    ...
    @Test
    public void formatsThreeDObjectOipReplayFromRecordedParameters() {
        BinConfig cfg = new BinConfig();
        cfg.channelNames.add("DAPI");
        cfg.channelNames.add("Iba1");
        Map<String, Object> params = new LinkedHashMap<String, Object>();
        params.put("doVolumetric", Boolean.TRUE);
        params.put("doCpc", Boolean.TRUE);
        params.put("doRadialProfile", Boolean.FALSE);
        params.put("doMarginalProfile", Boolean.FALSE);
        params.put("doPrincipalAxisProfile", Boolean.TRUE);
        params.put("doAngularProfile", Boolean.TRUE);
        params.put("doShellColoc", Boolean.TRUE);
        params.put("doWithinBoxCorr", Boolean.TRUE);
        params.put("oipGenerateFigures", Boolean.FALSE);
        params.put("oipRegion", "OBJECT_VOXELS");
        params.put("oipIntensityNorm", "ZSCORE");
        params.put("oipRadialBins", Integer.valueOf(16));
        params.put("oipAngularBins", Integer.valueOf(8));
        params.put("oipShells", Integer.valueOf(4));
        params.put("oipResampleN", Integer.valueOf(64));
        params.put("oipBoxPadPct", Double.valueOf(10.0));
        params.put("oipRingThresholdPct", Double.valueOf(35.0));

        String options = extractOptions(ReplayCommandFormatter.format(
                "C:/data", 4, cfg, null, params));
        CLIConfig parsed = CLIArgumentParser.parse(options);

        assertTrue(options.contains("object.oip.radial=false"));
